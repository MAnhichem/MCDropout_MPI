...
pred_time_serial_n2 = prediction_time_n2['pred_time_serial'].values
pred_time_serial_n4 = prediction_time_n4['pred_time_serial'].values
pred_time_serial_n6 = prediction_time_n6['pred_time_serial'].values
pred_time_serial_n8 = prediction_time_n8['pred_time_serial'].values
...
plt.plot(mc_samples, pred_time_serial_n2, marker='o', c = 'tab:gray')
plt.plot(mc_samples, pred_time_n2, marker='o', c = 'tab:blue')
plt.plot(mc_samples, pred_time_n4, marker='o', c = 'tab:orange')
plt.plot(mc_samples, pred_time_n6, marker='o', c = 'tab:green')
plt.plot(mc_samples, pred_time_n8, marker='o', c = 'tab:red')
plt.xscale('log')
...
plt.plot(mc_samples, pred_time_serial_n2/pred_time_n2, marker='o', c = 'tab:blue')
plt.plot(mc_samples, pred_time_serial_n4/pred_time_n4, marker='o', c = 'tab:orange')
plt.plot(mc_samples, pred_time_serial_n6/pred_time_n6, marker='o', c = 'tab:green')
plt.plot(mc_samples, pred_time_serial_n8/pred_time_n8, marker='o', c = 'tab:red')
plt.xscale('log')
plt.xlabel(r'Monte Carlo samples [-]', fontsize=23)
